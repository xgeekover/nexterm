...
| `tests/adversarial/` | 427 | Everything that has ever gone wrong, plus the invariants that keep it from going wrong again |
| `tests/render/` | 15 | Whether the app DRAWS — the only suite that mounts a component |
